/* Article data part 1/3 — pushes into the global ARTICLES array from data-core.js */
ARTICLES.push(
{
  "id": 1,
  ...
  "ar": {
    "title": "الحكومة تعلن التخلي نهائيا عن التوقيت الصيفي بعد نهاية الصيف",
  ...
  "fr": {
    "title": "Le gouvernement annonce l'abandon définitif de l'heure d'été",
  ...
  "en": {
    "title": "Government announces permanent end to daylight saving time",
...
},
{
  ...
  "ar": {
    "title": "استفسارات عاجلة لوزارة الداخلية بشأن تضارب المصالح في جهتين كبريين",
  ...
  "fr": {
    "title": "Le ministère de l'Intérieur exige des explications sur des conflits d'intérêts locaux",
  ...
  "en": {
    "title": "Interior Ministry demands answers over local conflicts of interest",
...
},
{
  ...
  "ar": {
    "title": "تقلبات أسعار النفط العالمية تنعش آمال المغاربة في وقود أرخص",
  ...
  "fr": {
    "title": "Les fluctuations du pétrole mondial nourrissent l'espoir d'un carburant moins cher",
  ...
  "en": {
    "title": "Global oil price swings fuel hopes of cheaper fuel in Morocco",
...
},
{
  ...
  "ar": {
    "title": "الحكومة تعلن تسارع النمو الاقتصادي نحو 5.2 بالمائة سنة 2026",
  ...
  "fr": {
    "title": "Le gouvernement annonce une accélération de la croissance à 5,2% en 2026",
  ...
  "en": {
    "title": "Government announces economic growth accelerating to 5.2% in 2026",
...
},
{
  ...
  "ar": {
    "title": "حوادث السير تخلف 42 قتيلا وقرابة 3000 جريح خلال أسبوع واحد",
  ...
  "fr": {
    "title": "Les accidents de la route font 42 morts et près de 3000 blessés en une semaine",
  ...
  "en": {
    "title": "Traffic accidents kill 42, injure nearly 3,000 in a single week",
...
},
{
  ...
  "ar": {
    "title": "توصية بإلغاء سقف السن في امتحان ولوج مهنة المحاماة",
  ...
  "fr": {
    "title": "Recommandation de supprimer la limite d'âge pour l'examen d'avocat",
  ...
  "en": {
    "title": "Recommendation to scrap age cap on bar exam eligibility",
...
},
{
  ...
  "ar": {
    "title": "المغرب يقصي هولندا بركلات الترجيح ويبلغ ثمن نهائي المونديال",
  ...
  "fr": {
    "title": "Le Maroc élimine les Pays-Bas aux tirs au but et file en 8es de finale",
  ...
  "en": {
    "title": "Morocco eliminates Netherlands on penalties, reaches World Cup round of 16",
...
},
{
  ...
  "ar": {
    "title": "المغرب يواجه كندا السبت في هيوستن.. ولارام تسير جسرا جويا للمشجعين",
  ...
  "fr": {
    "title": "Le Maroc affronte le Canada samedi à Houston, avec un pont aérien pour les supporters",
  ...
  "en": {
    "title": "Morocco faces Canada Saturday in Houston, with extra flights laid on for fans",
...
},
{
  ...
  "ar": {
    "title": "قمة تقنية عالمية بثلاث مدن مغربية حول 'التوائم الرقمية' للتنمية الترابية",
  ...
  "fr": {
    "title": "Un sommet technologique mondial dans trois villes marocaines sur les 'jumeaux numériques'",
  ...
  "en": {
    "title": "Global tech summit across three Moroccan cities on 'digital twins' for regional development",
...
},
{
  ...
  "ar": {
    "title": "عمدة مراكش تعقد لقاء تنسيقيا حول تنظيم ساحة جامع الفنا",
  ...
  "fr": {
    "title": "La maire de Marrakech tient une réunion sur l'organisation de la place Jemaa el-Fna",
  ...
  "en": {
    "title": "Marrakech mayor holds coordination meeting on Jemaa el-Fna square",
...
},
{
  ...
  "ar": {
    "title": "التنوع الثقافي يفتتح مهرجان كناوة بالصويرة",
  ...
  "fr": {
    "title": "La diversité culturelle à l'honneur à l'ouverture du festival Gnaoua à Essaouira",
  ...
  "en": {
    "title": "Cultural diversity opens Gnaoua Festival in Essaouira",
...
},
{
  ...
  "ar": {
    "title": "مهرجان موازين يختتم دورته الـ21 بين الرباط وسلا",
  ...
  "fr": {
    "title": "Le festival Mawazine clôture sa 21e édition entre Rabat et Salé",
  ...
  "en": {
    "title": "Mawazine Festival wraps 21st edition across Rabat and Salé",
...
},
{
  ...
  "ar": {
    "title": "موجة حر تستنفر الأطباء ودعوات لحماية الأطفال والمسنين",
  ...
  "fr": {
    "title": "Une vague de chaleur mobilise les médecins, appels à protéger enfants et seniors",
  ...
  "en": {
    "title": "Heat wave puts doctors on alert, calls to protect children and the elderly",
...
},
{
  ...
  "time": {
    "ar": "في وقت سابق من هذا العام",
    "fr": "plus tôt cette année",
    "en": "earlier this year"
  },
  "ar": {
    "title": "المغرب يجدد التزامه بحماية صحة الأطفال عبر التلقيح المجاني",
  ...
  "fr": {
    "title": "Le Maroc réaffirme son engagement pour la santé infantile via la vaccination gratuite",
  ...
  "en": {
    "title": "Morocco reaffirms commitment to child health through free vaccination",
...
},
{
  ...
  "ar": {
    "title": "مشروع قانون جديد للإدارة الرقمية يتضمن مقتضيات خاصة بالذكاء الاصطناعي",
  ...
  "fr": {
    "title": "Un nouveau projet de loi sur l'administration numérique intègre des dispositions sur l'IA",
  ...
  "en": {
    "title": "New digital administration bill includes AI-specific provisions",
...
},
{
  ...
  "time": {
    ...
    "en": "since earlier this year"
  },
  "ar": {
    "title": "المغرب يطلق خارطة طريق 'الذكاء الاصطناعي صنع في المغرب' وشبكة معاهد الجزري",
  ...
  "fr": {
    "title": "Le Maroc lance sa feuille de route 'IA Made in Morocco' et son réseau d'instituts Jazari",
  ...
  "en": {
    "title": "Morocco launches 'AI Made in Morocco' roadmap and Jazari institute network",
...
},
{
  ...
  "ar": {
    "title": "أحكام قضية 'إسكوبار الصحراء': 10 سنوات سجنا للناصري و12 سنة لبعيوي",
    "excerpt": "قرار قضائي في ملف تهريب دولي أثار اهتماما واسعا لدى الرأي العام.",
    "body": [
      "أصدرت محكمة مغربية أحكاما بالسجن في حق المتهمين الرئيسيين بملف 'إسكوبار الصحراء'، بمعدل 10 سنوات للناصري و12 سنة لبعيوي.",
      "وتابع الرأي العام تفاصيل هذه القضية التي شغلت الساحة الإعلامية لأشهر بسبب حجم الشبكة المتورطة."
    ]
  },
  "fr": {
    "title": "Affaire 'Escobar du Sahara' : 10 ans de prison pour Nasseri, 12 ans pour Bouiya",
    "excerpt": "Une décision de justice dans un dossier de trafic international très suivi par l'opinion publique.",
    "body": [
      "Un tribunal marocain a prononcé des peines de prison contre les principaux accusés de l'affaire 'Escobar du Sahara', 10 ans pour Nasseri et 12 ans pour Bouiya.",
      "L'opinion publique a suivi de près les développements de ce dossier qui a occupé l'actualité pendant des mois en raison de l'ampleur du réseau impliqué."
    ]
  },
  "en": {
    "title": "'Sahara Escobar' case: 10-year sentence for Nasseri, 12 years for Bouiya",
    "excerpt": "A court ruling in a closely watched international trafficking case.",
    "body": [
      "A Moroccan court sentenced the main defendants in the 'Sahara Escobar' case to prison, 10 years for Nasseri and 12 years for Bouiya.",
      "The public closely followed the case, which dominated headlines for months given the scale of the network involved."
    ]
  }
},
{
  ...
  "ar": {
    "title": "بايتاس: قرار العودة إلى الساعة القانونية نهائي وهذا موعد التنفيذ",
    "excerpt": "الناطق باسم الحكومة يؤكد عدم الرجوع في قرار إلغاء التوقيت الصيفي.",
    "body": [
      "أكد الناطق الرسمي باسم الحكومة مصطفى بايتاس أن قرار العودة إلى التوقيت القانوني بات نهائيا ولن يتم التراجع عنه.",
      "وحدد بايتاس موعدا واضحا لدخول القرار حيز التنفيذ، منهيا بذلك الجدل حول تاريخ التطبيق."
    ]
  },
  "fr": {
    "title": "Baitas : le retour à l'heure légale est définitif, voici la date d'entrée en vigueur",
    "excerpt": "Le porte-parole du gouvernement confirme qu'il n'y aura pas de marche arrière.",
    "body": [
      "Le porte-parole du gouvernement, Mustapha Baitas, a confirmé que la décision de revenir à l'heure légale est désormais définitive et ne sera pas annulée.",
      "Baitas a fixé une date précise pour l'entrée en vigueur de la décision, mettant fin aux incertitudes sur le calendrier."
    ]
  },
  "en": {
    "title": "Baitas: return to standard time is final, here's the date",
    "excerpt": "The government spokesperson confirms there will be no reversal of the decision.",
    "body": [
      "Government spokesperson Mustapha Baitas confirmed that the decision to return to standard time is now final and will not be reversed.",
      "Baitas set a clear date for the decision to take effect, ending uncertainty over the timeline."
    ]
  }
},
{
  ...
  "ar": {
    "title": "تصريحات 'العيناوي الأب' تثير جدلا سياسيا.. ودعوات لعدم التهويل",
    "excerpt": "محللون يدعون إلى التعامل بهدوء مع التصريحات المثيرة للجدل.",
    "body": [
      "أثارت تصريحات منسوبة لوالد أحد اللاعبين الوطنيين جدلا واسعا على مواقع التواصل الاجتماعي والأوساط السياسية.",
      "ودعا عدد من المحللين إلى عدم التهويل من الموضوع والتعامل معه بعيدا عن التشويش الإعلامي."
    ]
  },
  "fr": {
    "title": "Des propos attribués au père d'Al Aynaoui suscitent la polémique",
    "excerpt": "Des analystes appellent à ne pas dramatiser la situation.",
    "body": [
      "Des déclarations attribuées au père d'un joueur de l'équipe nationale ont suscité une vive polémique sur les réseaux sociaux et dans les milieux politiques.",
      "Plusieurs analystes ont appelé à ne pas dramatiser l'affaire et à l'aborder sans confusion médiatique."
    ]
  },
  "en": {
    "title": "Comments attributed to Al Aynaoui's father spark controversy",
    "excerpt": "Analysts call for calm rather than dramatizing the remarks.",
    "body": [
      "Remarks attributed to the father of a national team player triggered widespread controversy on social media and in political circles.",
      "Several analysts called for a measured response rather than sensationalizing the issue."
    ]
  }
},
{
  ...
  "ar": {
    "title": "التعديلات الانتخابية لسنة 2026: قراءة في أبرز المستجدات القانونية",
    "excerpt": "تحليل للتغييرات التي عرفها الإطار القانوني المنظم للانتخابات المقبلة.",
    "body": [
      "تناول محللون التعديلات القانونية المدخلة على الإطار المنظم للانتخابات التشريعية المقبلة لسنة 2026.",
      "وركزت القراءات على أثر هذه التعديلات على التوازنات الحزبية وعلى مسار العملية الانتخابية برمتها."
    ]
  },
  "fr": {
    "title": "Amendements électoraux 2026 : lecture des principales nouveautés juridiques",
    "excerpt": "Analyse des changements apportés au cadre juridique régissant les prochaines élections.",
    "body": [
      "Des analystes ont examiné les amendements juridiques apportés au cadre régissant les élections législatives de 2026.",
      "Ces lectures se sont concentrées sur l'impact de ces changements sur les équilibres partisans et le processus électoral."
    ]
  },
  "en": {
    "title": "2026 electoral amendments: a look at the key legal changes",
    "excerpt": "Analysis of changes to the legal framework governing upcoming elections.",
    "body": [
      "Analysts examined the legal amendments made to the framework governing the 2026 legislative elections.",
      "The analyses focused on how these changes could affect party balances and the overall electoral process."
    ]
  }
},
{
  ...
  "ar": {
    "title": "الحكومة تصادق على مشروع قانون يهم القطاع العقاري",
    "excerpt": "خطوة تشريعية جديدة ضمن ورش إصلاح الإطار القانوني للعقار بالمغرب.",
    "body": [
      "صادق مجلس الحكومة على مشروع قانون يتعلق بتنظيم القطاع العقاري، في إطار مواصلة أوراش الإصلاح القانوني.",
      "ويرتقب أن يعرض المشروع على البرلمان لاستكمال المسطرة التشريعية قبل دخوله حيز التنفيذ."
    ]
  },
  "fr": {
    "title": "Le gouvernement adopte un projet de loi sur le secteur immobilier",
    "excerpt": "Une nouvelle étape législative dans la réforme du cadre juridique de l'immobilier.",
    "body": [
      "Le Conseil de gouvernement a adopté un projet de loi relatif à la régulation du secteur immobilier, dans le cadre des chantiers de réforme juridique en cours.",
      "Le texte devrait être soumis au Parlement pour achever la procédure législative avant son entrée en vigueur."
    ]
  },
  "en": {
    "title": "Government adopts bill on the real estate sector",
    "excerpt": "A new legislative step in reforming the legal framework for real estate.",
    "body": [
      "The Council of Government adopted a bill regulating the real estate sector, part of ongoing legal reform efforts.",
      "The bill is expected to go before parliament to complete the legislative process before taking effect."
    ]
  }
},
{
  ...
  "ar": {
    "title": "لجنة 'الفراقشية' البرلمانية تشعل مواجهة بين الأغلبية والمعارضة",
    "excerpt": "اتهامات متبادلة بالمماطلة والاستغلال السياسي داخل قبة البرلمان.",
    "body": [
      "شهدت أشغال لجنة برلمانية معنية بملف تهريب المحروقات مواجهة حادة بين فرق الأغلبية والمعارضة.",
      "وتبادل الطرفان اتهامات بالمماطلة في تدبير الملف واستغلاله لأغراض سياسية قبيل الاستحقاقات الانتخابية."
    ]
  },
  "fr": {
    "title": "La commission parlementaire sur la contrebande de carburant attise les tensions",
    "excerpt": "Accusations croisées de blocage et d'instrumentalisation politique au Parlement.",
    "body": [
      "Les travaux d'une commission parlementaire chargée du dossier de la contrebande de carburant ont donné lieu à un vif affrontement entre majorité et opposition.",
      "Les deux camps se sont mutuellement accusés de ralentir le dossier et de l'instrumentaliser à l'approche des échéances électorales."
    ]
  },
  "en": {
    "title": "Parliamentary fuel-smuggling committee sparks clash between majority and opposition",
    "excerpt": "Mutual accusations of stalling and political point-scoring in parliament.",
    "body": [
      "A parliamentary committee investigating fuel smuggling saw a sharp clash between majority and opposition lawmakers.",
      "Both sides accused each other of stalling the case and exploiting it for political gain ahead of upcoming elections."
    ]
  }
},
{
  ...
  "ar": {
    "title": "الدرهم يرتفع 1.4% مقابل الدولار ويستقر أمام الأورو",
    "excerpt": "بنك المغرب يكشف عن تطور سعر صرف العملة الوطنية خلال الأسابيع الأخيرة.",
    "body": [
      "أفاد بنك المغرب بأن سعر الدرهم ارتفع بنسبة 1.4 بالمائة مقابل الدولار الأمريكي، فيما ظل شبه مستقر أمام الأورو.",
      "ويأتي هذا التطور في سياق تقلبات عرفتها أسواق الصرف الدولية خلال الفترة الأخيرة."
    ]
  },
  "fr": {
    "title": "Le dirham progresse de 1,4% face au dollar et reste stable face à l'euro",
    "excerpt": "Bank Al-Maghrib publie l'évolution du taux de change de la monnaie nationale.",
    "body": [
      "Bank Al-Maghrib a indiqué que le dirham a progressé de 1,4% face au dollar américain, tout en restant quasiment stable face à l'euro.",
      "Cette évolution intervient dans un contexte de fluctuations sur les marchés des changes internationaux."
    ]
  },
  "en": {
    "title": "Dirham rises 1.4% against the dollar, stable against the euro",
    "excerpt": "Bank Al-Maghrib reports on the national currency's recent exchange rate movements.",
    "body": [
      "Bank Al-Maghrib said the dirham rose 1.4% against the US dollar while remaining largely stable against the euro.",
      "The move comes amid recent volatility in international currency markets."
    ]
  }
},
{
  ...
  "ar": {
    "title": "تراجع أسعار النفط عالميا بعد قرار مفاجئ لأوبك+ برفع الإنتاج",
    "excerpt": "الخطوة فاجأت الأسواق ودفعت الأسعار إلى التراجع.",
    "body": [
      "تراجعت أسعار النفط عالميا بعد أن فاجأت مجموعة أوبك+ الأسواق بقرار رفع الإنتاج أكثر من المتوقع.",
      "ويترقب مستهلكون مغاربة انعكاس هذا التراجع على أسعار المحروقات المحلية في التحيينات القادمة."
    ]
  },
  "fr": {
    "title": "Les prix du pétrole reculent après une décision surprise de l'OPEP+",
    "excerpt": "La décision a surpris les marchés et fait baisser les cours.",
    "body": [
      "Les prix du pétrole ont reculé sur les marchés mondiaux après que l'OPEP+ a surpris en annonçant une hausse de production supérieure aux attentes.",
      "Les consommateurs marocains espèrent que cette baisse se répercutera sur les prix des carburants lors des prochaines actualisations."
    ]
  },
  "en": {
    "title": "Oil prices fall after OPEC+ surprise output hike",
    "excerpt": "The move caught markets off guard and pushed prices lower.",
    "body": [
      "Global oil prices fell after OPEC+ surprised markets with a bigger-than-expected production increase.",
      "Moroccan consumers are hoping the drop will feed through to local fuel prices at the next update."
    ]
  }
},
{
  ...
  "ar": {
    "title": "رجل أعمال مصري يستعد لدخول السوق المغربية عبر شركة تحويل الدراجات الكهربائية",
    "excerpt": "استثمار جديد يستهدف قطاع التنقل الكهربائي الناشئ بالمغرب.",
    "body": [
      "يستعد رجل الأعمال نجيب ساويرس، عبر شركته المتخصصة في تحويل الدراجات النارية للعمل بالكهرباء، لدخول السوق المغربية.",
      "ويأتي هذا الاستثمار في سياق نمو متزايد لقطاع التنقل الكهربائي في المنطقة."
    ]
  },
  "fr": {
    "title": "Un homme d'affaires égyptien prépare son entrée sur le marché marocain de la mobilité électrique",
    "excerpt": "Un nouvel investissement cible le secteur naissant des deux-roues électriques.",
    "body": [
      "L'homme d'affaires Naguib Sawiris, à travers sa société spécialisée dans la conversion de motos à l'électrique, prépare son entrée sur le marché marocain.",
      "Cet investissement s'inscrit dans la croissance du secteur de la mobilité électrique dans la région."
    ]
  },
  "en": {
    "title": "Egyptian businessman prepares entry into Morocco's electric mobility market",
    "excerpt": "A new investment targets the emerging electric two-wheeler sector.",
    "body": [
      "Businessman Naguib Sawiris, through his company specializing in converting motorcycles to electric power, is preparing to enter the Moroccan market.",
      "The investment comes amid growing regional interest in electric mobility."
    ]
  }
},
{
  ...
  "ar": {
    "title": "المغرب يستعد لإنهاء 7 سنوات من التوقف عن إصدار الصكوك",
    "excerpt": "عودة متوقعة لإصدار الصكوك عبر البنوك التشاركية.",
    "body": [
      "يستعد المغرب لإنهاء توقف دام 7 سنوات عن إصدار الصكوك، من خلال العودة إلى هذه التجربة عبر البنوك التشاركية.",
      "وتأتي هذه الخطوة ضمن مساع لتنويع أدوات التمويل المتاحة للدولة والفاعلين الاقتصاديين."
    ]
  },
  "fr": {
    "title": "Le Maroc s'apprête à mettre fin à 7 ans d'absence d'émissions de sukuk",
    "excerpt": "Un retour attendu via les banques participatives.",
    "body": [
      "Le Maroc se prépare à mettre fin à une interruption de 7 ans dans l'émission de sukuk, en y revenant via les banques participatives.",
      "Cette démarche s'inscrit dans une volonté de diversifier les instruments de financement disponibles."
    ]
  },
  "en": {
    "title": "Morocco set to end 7-year pause in sukuk issuance",
    "excerpt": "An expected return via participative banks.",
    "body": [
      "Morocco is preparing to end a seven-year pause in sukuk issuance by returning to the practice through participative banks.",
      "The move is part of efforts to diversify available financing instruments for the state and economic actors."
    ]
  }
},
{
  ...
  "ar": {
    "title": "مجلة فرنسية: المغرب من أكثر الوجهات الاستثمارية جاذبية في إفريقيا",
    "excerpt": "تقرير دولي يبرز مكانة المملكة ضمن الوجهات المفضلة للمستثمرين.",
    "body": [
      "اعتبرت مجلة 'أوليس' الفرنسية المتخصصة أن المغرب يواصل ترسيخ مكانته كواحدة من أكثر الوجهات الاستثمارية جذبا في القارة الإفريقية.",
      "ويستند هذا التصنيف إلى معطيات حول استقرار المناخ الاستثماري وجودة البنية التحتية بالمملكة."
    ]
  },
  "fr": {
    "title": "Un magazine français : le Maroc parmi les destinations d'investissement les plus attractives d'Afrique",
    "excerpt": "Un rapport international souligne la position du Royaume auprès des investisseurs.",
    "body": [
      "Le magazine spécialisé français 'Oléüs' a estimé que le Maroc continue de consolider sa position comme l'une des destinations d'investissement les plus attractives d'Afrique.",
      "Ce classement s'appuie sur la stabilité du climat d'investissement et la qualité des infrastructures du Royaume."
    ]
  },
  "en": {
    "title": "French magazine: Morocco among Africa's most attractive investment destinations",
    "excerpt": "An international report highlights the Kingdom's standing with investors.",
    "body": [
      "French trade magazine 'Oléüs' said Morocco continues to cement its position as one of Africa's most attractive investment destinations.",
      "The ranking cites investment climate stability and infrastructure quality in the Kingdom."
    ]
  }
},
{
  ...
  "ar": {
    "title": "مداخيل الوكالة الوطنية للمحافظة العقارية تتجاوز 9.3 مليار درهم",
    "excerpt": "نمو قوي في رقم معاملات المحافظة العقارية والمسح العقاري خلال 2024.",
    "body": [
      "حققت الوكالة الوطنية للمحافظة العقارية والمسح العقاري والخرائطية نموا قويا في مداخيلها لسنة 2024، بلغ 9.33 مليار درهم.",
      "ويعكس هذا الرقم دينامية السوق العقارية المغربية رغم التحديات التي يعرفها القطاع."
    ]
  },
  "fr": {
    "title": "Les recettes de l'Agence de la conservation foncière dépassent 9,3 milliards de dirhams",
    "excerpt": "Une forte croissance du chiffre d'affaires en 2024.",
    "body": [
      "L'Agence nationale de la conservation foncière, du cadastre et de la cartographie a enregistré une forte croissance de ses recettes en 2024, atteignant 9,33 milliards de dirhams.",
      "Ce chiffre reflète le dynamisme du marché immobilier marocain malgré les défis du secteur."
    ]
  },
  "en": {
    "title": "Land registry agency revenue tops 9.3 billion dirhams",
    "excerpt": "Strong revenue growth recorded in 2024.",
    "body": [
      "Morocco's national land registry and mapping agency posted strong revenue growth in 2024, reaching 9.33 billion dirhams.",
      "The figure reflects the dynamism of Morocco's real estate market despite sector challenges."
    ]
  }
},
{
  ...
  "ar": {
    "title": "مطار محمد الخامس يستعد لاحتضان أكبر مشروع في تاريخه",
    "excerpt": "محطة جديدة بطاقة استيعابية تصل إلى 30 مليون مسافر سنويا.",
    "body": [
      "يستعد مطار محمد الخامس بالدار البيضاء لاحتضان أكبر مشروع بناء في تاريخه، باستثمار يقدر بـ10 مليارات درهم.",
      "وستقام المحطة الجديدة على مساحة 600 ألف متر مربع، بطاقة أولية تبلغ 20 مليون مسافر سنويا قابلة للتوسيع إلى 30 مليونا."
    ]
  },
  "fr": {
    "title": "L'aéroport Mohammed V se prépare à son plus grand projet",
    "excerpt": "Un nouveau terminal d'une capacité pouvant atteindre 30 millions de passagers par an.",
    "body": [
      "L'aéroport Mohammed V de Casablanca se prépare à accueillir le plus grand projet de construction de son histoire, pour un investissement estimé à 10 milliards de dirhams.",
      "Le nouveau terminal s'étendra sur 600 000 m², avec une capacité initiale de 20 millions de passagers par an, extensible à 30 millions."
    ]
  },
  "en": {
    "title": "Mohammed V Airport prepares for its biggest project yet",
    "excerpt": "A new terminal with capacity for up to 30 million passengers a year.",
    "body": [
      "Casablanca's Mohammed V Airport is preparing for the largest construction project in its history, with an estimated investment of 10 billion dirhams.",
      "The new terminal will span 600,000 square meters, with an initial capacity of 20 million passengers a year, expandable to 30 million."
    ]
  }
},
{
  ...
  "ar": {
    "title": "المغرب يسرع الخطى نحو تأسيس صناعة محلية للألعاب الإلكترونية",
    "excerpt": "قطاع واعد يراهن عليه المغرب في ظل النمو العالمي المتسارع لصناعة الألعاب.",
    "body": [
      "قرر المغرب الانطلاق بسرعة نحو تأسيس صناعة محلية للألعاب الإلكترونية، مواكبة للنمو الصاروخي الذي يعرفه هذا المجال عالميا.",
      "وتراهن الجهات المعنية على استقطاب مطورين ومقاولات ناشئة في هذا القطاع الواعد."
    ]
  },
  "fr": {
    "title": "Le Maroc accélère vers une industrie locale du jeu vidéo",
    "excerpt": "Un secteur prometteur sur lequel le Maroc mise face à la croissance mondiale du gaming.",
    "body": [
      "Le Maroc a décidé d'accélérer la mise en place d'une industrie locale du jeu vidéo, en phase avec la croissance fulgurante de ce secteur à l'échelle mondiale.",
      "Les autorités concernées misent sur l'attraction de développeurs et de start-up dans ce secteur prometteur."
    ]
  },
  "en": {
    "title": "Morocco accelerates toward building a local video game industry",
    "excerpt": "A promising sector Morocco is betting on amid rapid global gaming growth.",
    "body": [
      "Morocco has decided to move quickly to build a local video game industry, in step with the sector's rapid global growth.",
      "Relevant authorities are counting on attracting developers and startups to this promising field."
    ]
  }
}
);
